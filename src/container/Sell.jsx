...
class Sell extends Component {
    state = {
        ...
        Details : [{Category: 'Mobiles', SubCategory:'Tablets', Div:[{title:'Type',type:'button', options:['Apple','Danny Tabs','Q Tabs','Samsung','Other Tablets']},{type:'button',title:'Condition', options:['No','Yes']}]},
                   {Category: 'Mobiles', SubCategory:'Mobile Acessories', Div:[{title:'Type', type:'button', options:['Mobiles','Tablets']},{type:'button',title:'Condition', options:['No','Yes']}]},
                   ...
                   {Category: 'Vehicles', SubCategory:'Cars Accessories',Div:[{type:'button',title:'Condition', options:['No','Yes']}]},
                   {Category: 'Vehicles', SubCategory:'Spare Parts', Div:[{type:'button',title:'Condition', options:['No','Yes']},{title:'Type', type:'button', options:['Car Parts', 'Other Parts']}]},
                   {Category: 'Vehicles', SubCategory:'Buses, Vans & Trucks', Div:[{type:'button',title:'Condition', options:['No','Yes']},{title:'Year', type:'input'},{title:'KMs driven', type:'input'}]},
                   {Category: 'Vehicles', SubCategory:'Rickshaw & Chingchi', Div:[{type:'button',title:'Condition', options:['No','Yes']},{title:'Year', type:'input'},{title:'KMs driven', type:'input'}]},
                   {Category: 'Vehicles', SubCategory:'Other Vehicles', Div:[{type:'button',title:'Condition', options:['No','Yes']}]},
                   {Category: 'Vehicles', SubCategory:'Boats'},
                   {Category: 'Vehicles', SubCategory:'Tractors & Trailers', Div:[{title:'Year', type:'input'},{title:'KMs driven', type:'input'}]},
                   ...
                   {Category: 'Electronics & Home Aplpliances', SubCategory:'Computers & Accessories', Div:[{title:'Type', type:'select', options:['','Computers', 'Hard Disk', 'Internet', 'Laptops', 'Monitors', 'Printers', 'Other Accessories']}]},
                   {Category: 'Electronics & Home Aplpliances', SubCategory:'TV - Video - Audio', Div:[{title:'Type', type:'button', options:['TV', 'Video - Audio']}]},
                   {Category: 'Electronics & Home Aplpliances', SubCategory:'Cameras & Accessories', Div:[{title:'Type', type:'button', options:['Cameras', 'Lenses', 'Other Accessories']}]},
                   {Category: 'Electronics & Home Aplpliances', SubCategory:'Games & Entertainment'},
                   {Category: 'Electronics & Home Aplpliances', SubCategory:'Other Home Appliances', Div:[{title:'Type', type:'select', options:['','Fans','Iron','Sewing Machines','Vacuum Cleaners','Water Dispensers','Other']}]},
                   {Category: 'Electronics & Home Aplpliances', SubCategory:'Generators, UPS & Power Solutions', Div:[{title:'Type', type:'button', options:['Batteries','Generators','Solar','UPS','Other']}]},
                   {Category: 'Electronics & Home Aplpliances', SubCategory:'Kitchen Appliances', Div:[{title:'Type', type:'select', options:['','Cooking Range','Iron','Sewing Machines','Vacuum Cleaners','Water Dispensers','Other']}]},
                   ...
                   {Category: 'Bikes', SubCategory:'Motorcycles', Div:[{title:'Make',type:'select', options:['','Crown','Eagle','Ghani','Habib','Harley Davidson','Honda','Kawasaki','Metro','Power','Ravi','Road Prince','Sohrab','Sports & Heavy Bikes','Super Power','Super Star','Suzuki','Unique','United','VESPA','Yamaha','Other Brands']},{title:'Year', type:'input'}]},
                   {Category: 'Bikes', SubCategory:'Spare Parts'},
                   {Category: 'Bikes', SubCategory:'Bicycles'},
                   {Category: 'Bikes', SubCategory:'ATV & Quads'},
                   {Category: 'Bikes', SubCategory:'Scooters', Div:[{title:'Year',type:'input'},{title:'KMs driven', type:'input'}]},
